...
# Get the OBSIDIAN_NOTES_DIR from environment variables
obsidian_notes_dir = os.getenv('OBSIDIAN_NOTES_DIR')

if obsidian_notes_dir is None:
    raise ValueError("Environment variable 'OBSIDIAN_NOTES_DIR' is not set.")

# Construct the full file path using the environment variable
file_path = os.path.join(obsidian_notes_dir, 'Untitled.md')
